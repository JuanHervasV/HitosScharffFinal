                ...
                mFusedLocationClient.getLastLocation().addOnCompleteListener(
                        new OnCompleteListener<Location>() {
                            ...
                            public void onComplete(@NonNull Task<Location> task) {
                                ...
                                //Llamar datos usuario--------------------------
                                Bundle b = getIntent().getExtras();
                                final String usuario = b.getString("Key");
                                final String spinnerdata = b.getString("Key3");

                                final String valormoneda = b.getString("Pkey1");
                                final String tipotransvalue = b.getString("Pkey2");
                                final String tipopago = b.getString("Pkey3");
                                final String tipodoc = b.getString("Pkey4");
                                final String despachodni = b.getString("Pkey5");
                                final String transportecodigo = b.getString("Pkey6");
                                String transportedescrip2 = b.getString("Pkey7");
                                final String valorfletef = b.getString("Pkey8");
                                final String seriul = b.getString("Pkey9");
                                final String docul = b.getString("Pkey10");
                                final String despachNumo = b.getString("Pkey11");
                                final String DNIUsuario = b.getString("Pkey12");
                                        ...
                                        if(valormoneda!=null){
                                                            ...
                                                            callz.enqueue(new Callback<InsertarDatosFac>() {
                                                                ...
                                                                public void onResponse(Call<InsertarDatosFac> callo, Response<InsertarDatosFac> response) {
                                                                    ...
                                                                    //Aqui enviar los datos
                                                                    //String resul = mTvResult.getText().toString();
                                                                    HitoFactura hitoFactura = new HitoFactura(""+DNIUsuario, ""+DNIUsuario, "" + transportecodigo, ""+tipotransvalue,"" + valormoneda + "", ""+valorfletef, ""+tipopago, ""+tipodoc, ""+seriul,""+docul);
                                                                    Call<HitoFactura> callp = jsonPlaceHolderApi.createPost(hitoFactura);
                                                                    callp.enqueue(new Callback<HitoFactura>() {
                                                                        @Override
                                                                        ...
                                                                        @Override
                                                                        public void onFailure(Call<HitoFactura> callo, Throwable t) {
                                            ...
                                            //Aqui enviar los datos
                                            //String resul = mTvResult.getText().toString();
                                            final Posts posts = new Posts(textItemList, "" + DNIUsuario, "" + location.getLatitude(), "" + location.getLongitude() + "", "" + spinnerdata/*+Estado*/, textItemList.substring(2, 4), textItemList.substring(textItemList.length() - 8), textItemList.substring(textItemList.length() - 8));
